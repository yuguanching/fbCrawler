...
def runFansPage(jsonArrayDataSub, fbDTSG, processNum) -> str:
    ...
    for target_url, target_name in zip(target_urls, target_names):
        ...
        if is_been_banned:
            ...
            continue
        # page_id, page_docid, page_req_name = "", "", ""
        ...
        if configSetting.operate_by_loading_db:
            ...
            post_list = crawlRequests.crawlPagePosts(pageURL=target_url, pageID=page_id, docID=page_docid,
                                                     reqName=page_req_name, proxyIpList=proxy_ip_list, processNum=processNum, targetName=target_name)
        ...
        feedback_docid = "8805087319518837"
